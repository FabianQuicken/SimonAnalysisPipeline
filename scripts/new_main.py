...
# do you want to move the raw dlc csv's from 'neww' to 'done' folder?
move_raw_csv = False
...
for deg_file in tqdm(deg_file_list):
    ...
    parameter_df["deg_is_investigating_leftsnicket"] = np.array(deg_df["leftsniffing"])
    parameter_df["deg_is_investigating_rightsnicket"] = np.array(deg_df["rightsniffing"])
